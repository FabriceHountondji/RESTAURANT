...
class ClientController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('dashboard/client/index', compact('title','users'));
    }
    ...
    public function create()
    {
        ...
        $roles = Roles::where('name', 'admin')
                        ->orWhere('name', 'client')->get();
        return view('dashboard/client/create', compact('title', 'roles'));
    }
    ...
    public function show(User $user)
    {
        ...
        return view('dashboard/client/show', compact('title', 'users'));
    }
