...
class CaissierController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('dashboard/caissier/index', compact('title','users'));
    }
    ...
    public function create()
    {
        ...
        $roles = Roles::where('name', 'admin')
                        ->orWhere('name', 'caissier')->get();
        return view('dashboard/caissier/create', compact('title', 'roles'));
    }
    ...
    public function show(User $user)
    {
        ...
        return view('dashboard/caissier/show', compact('title', 'users'));
    }
