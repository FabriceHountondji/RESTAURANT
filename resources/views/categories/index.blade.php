...
<div class="row">
            ...
            <div
                ...
                <div class="widget-chat-wrapper-outer">
                    <div class="widget-chart-content pt-3 pl-3 pb-1">
                        ...
                        <h6 class="widget-subheading mb-0 opacity-5">Total des catégories</h6>
                    </div>
            ...
            <div
                ...
                <div class="widget-chat-wrapper-outer">
                    <div class="widget-chart-content pt-3 pl-3 pb-1">
                        ...
                        <h6 class="widget-subheading mb-0 opacity-5">Nouvelles</h6>
                    </div>
                    <div class="no-gutters widget-chart-wrapper mt-3 mb-3 pl-2 he-auto row">
                        <div class="col-md-9">
    ...
    <div class="card mb-3">
        ...
        <div class="card-header-title font-size-lg text-capitalize font-weight-normal">
                <i class="header-icon lnr-laptop-phone mr-3 text-muted opacity-6"> </i>Liste des catégories
            </div>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="buttons">
                                    ...
                                    <a href="{{ route('categories.delete', $category) }}" class="btn btn-outline-danger" onclick="return confirm('Voulez-vous vraiment effectuer la suppression ?')">Supprimer</a>
                                </div>
                            </td>
                        </tr>
                    @endforeach
