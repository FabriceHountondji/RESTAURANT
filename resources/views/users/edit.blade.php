        ...
        <div class="card-body">
            ...
            <form id="signupForm" class="col-md-10 mx-auto" method="post" action="{{ route('users.update', $user->id) }}">
                ...
                <div class="form-group">
                    ...
                    <div>
                        <input type="text" class="form-control" id="username" name="username" placeholder="Username" value="{{ old('username') ? old('username') : $user->username }}" required/>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div>
                        <input type="email" class="form-control" id="email" name="email" placeholder=" Votre email" value="{{ old('email') ? old('email') : $user->email }}" required/>
                    </div>
                </div>
